<!-- 
This is the component for selecting bots, it depends on the Bot.vue as it renders n ammount from Array "$store.state.loadedBots" 
It also displays info if you click on a bot.
Authored by Wuxxerno 2019.
 -->
<template>
	<div id="wrap" >
